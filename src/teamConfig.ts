...
export interface TeamConfig {
    ...
    /** ウィンドウ再利用を有効にするか（連続オートモード時にサブエージェントウィンドウを閉じずに再利用） */
    ...
    try {
        if (fs.existsSync(filePath)) {
            ...
            return {
                ...
                enableWindowReuse: typeof parsed.enableWindowReuse === 'boolean' ? parsed.enableWindowReuse : DEFAULT_CONFIG.enableWindowReuse,
            };
        }
    } catch (e) {
