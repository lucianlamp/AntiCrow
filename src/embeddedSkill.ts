...
name: anticrow
description: AntiCrow 拡張機能の機能を活用するためのスキル。チームモード、オートモード、IPC通信、進捗報告、ファイル送信などの使い方を理解する。
---
...
オートモードは、AI が自律的に次のアクションを決定し、連続でタスクを実行する機能です。**Pro 限定機能。**
...
オートモードには21パターンの危険操作検知が組み込まれています:
...
- **Pro**: 全機能無制限（チームモード、オートモード、自動承認を含む）
