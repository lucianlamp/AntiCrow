...
export const messages = {
  ...
  'license.info.expiry': '\nExpires: {0}',
  'license.info.freeWarning': 'AntiCrow: {0}\nAll features available for $69.99 lifetime!',
  ...
  'admin.pro.lifetime': '♾️ **Lifetime** — $69.99 (one-time purchase, all features unlimited)',
  ...
  'admin.pro.lifetimeButton': '♾️ Lifetime ($69.99)',
