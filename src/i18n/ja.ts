...
export const messages = {
  ...
  'admin.pro.monthly': '📅 **Monthly** — $5/月（全機能無制限）',
  'admin.pro.lifetime': '♾️ **Lifetime** — $50（買い切り永久）',
  'admin.pro.featuresTitle': '**🔒 Pro 限定機能**',
  'admin.pro.autoAcceptLabel': '自動承認',
  ...
  'admin.pro.monthlyButton': '📅 Monthly ($5/月)',
  ...
  // -----------------------------------------------------------------------
  // autoModeController.ts — 自律モード関連
  // -----------------------------------------------------------------------
  'command.auto.desc': '自律モード — AIが自律的にタスクを連続実行します（Pro限定）',
  'command.auto.promptDesc': 'タスクのプロンプト（例: --steps 10 --confirm semi LPをリニューアルして）',
  'command.autoConfig.desc': '自律モードの設定を表示・変更します',
  ...
  'autoMode.started': '🚀 **自律モード開始**\n━━━━━━━━━━━━━━━━━━━━\n\n📝 タスク: {0}\n⚙️ 設定: 最大{1}ステップ / {2}分\n🔒 セーフティガード: 有効',
  'autoMode.stopped': '⏹️ **自律モード停止**\n\nステップ {0}/{1} で停止しました。',
  'autoMode.completed': '📊 **自律モード完了**\n━━━━━━━━━━━━━━━━━━━━\n\n✅ 完了ステップ: {0}/{1}\n⏱️ 合計時間: {2}\n🛡️ セーフティ発動: {3}回',
  'autoMode.stepComplete': '✅ **ステップ {0}/{1} 完了** ({2})\n━━━━━━━━━━━━━━━━━━━━\n\n📄 {3}',
  'autoMode.stepSuggestions': '\n\n💡 AIが参照した提案:\n{0}',
  'autoMode.progress': '\n\n⏱️ 経過: {0} / {1}分',
  'autoMode.error': '❌ **自律モードエラー**\n\nステップ {0} でエラーが発生しました: {1}',
  'autoMode.alreadyRunning': '⚠️ 自律モードは既に実行中です。先に `/stop` で停止してください。',
  'autoMode.proRequired': '⚠️ 自律モードは Pro プラン限定機能です。',
  'autoMode.notRunning': '⚠️ 自律モードは実行されていません。',
  ...
  'autoMode.safety.stopped': '🛑 セーフティチェックにより自律モードを停止しました。',
  'autoMode.safety.warn': '⚠️ **セーフティ警告**: {0}（パターン: `{1}`）— ループは続行します',

  // --- ヘルプ ---
  'admin.help.cmdAuto': '`/auto` — 自律モード（AI自律連続実行）Pro限定',
  ...
  'autoMode.confirm.continued': '▶️ 自律モードを続行します。',
  'autoMode.confirm.stopped': '🛑 確認モードにより自律モードを停止しました。',
