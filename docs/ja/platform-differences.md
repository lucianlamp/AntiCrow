...
| 起動コマンド | `Antigravity.exe --remote-debugging-port=9000` | `open -a Antigravity --args --remote-debugging-port=9000` | `antigravity --remote-debugging-port=9000` |
...
- ファイアウォールが `localhost:9000` をブロックしている場合、CDP 接続が失敗します
