...
- **Purpose:** License verification for the Pro plan
- **Storage:** Encrypted and stored in Antigravity's SecretStorage
- **Access:** Only accessible by this extension. Sent to the Lemonsqueezy API via HTTPS for verification

### Task Execution Counter

- **Purpose:** Managing daily/weekly task limits for the Free plan
- **Storage:** Stored locally in Antigravity's globalState
...
- License keys to third parties (verification is done solely via encrypted communication with the Lemonsqueezy API)
- Task execution counts or limit information
...
| Lemonsqueezy API | License key verification | License key (HTTPS encrypted communication) |
