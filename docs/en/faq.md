...
1. Enable with `/team` → "🟢 Team ON"
2. Send messages as usual (AI automatically splits tasks)
...
No. There are no daily or weekly task limits. All features including Continuous Auto Mode and Agent Team Mode are available for free.
